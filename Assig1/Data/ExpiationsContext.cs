...
public partial class ExpiationsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Expiation>(entity =>
        {
            ...
            entity.HasOne(d => d.DriverStateNavigation).WithMany(p => p.ExpiationDriverStateNavigations)
                .HasForeignKey(d => d.DriverState)
                .HasConstraintName("FK_Expiations_DriverState");

            entity.HasOne(d => d.LsaCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.LsaCode)
                .HasConstraintName("FK_Expiations_LSA");

            entity.HasOne(d => d.OffenceCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.OffenceCode)
                .HasConstraintName("FK_Expiations_Offences");

            entity.HasOne(d => d.PhotoRejCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.PhotoRejCode)
                .HasConstraintName("FK_Expiations_PhotoRejections");

            entity.HasOne(d => d.RegStateNavigation).WithMany(p => p.ExpiationRegStateNavigations)
                .HasForeignKey(d => d.RegState)
                .HasConstraintName("FK_Expiations_RegState");

            entity.HasOne(d => d.StatusCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.StatusCode)
                .HasConstraintName("FK_Expiations_Status");

            entity.HasOne(d => d.TypeCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.TypeCode)
                .HasConstraintName("FK_Expiations_NoticeType");

            entity.HasOne(d => d.WithdrawCodeNavigation).WithMany(p => p.Expiations)
                .HasForeignKey(d => d.WithdrawCode)
                .HasConstraintName("FK_Expiations_WithdrawReasons");

            entity.HasOne(d => d.CameraCode).WithMany(p => p.Expiations)
                .HasForeignKey(d => new { d.CameraLocationId, d.CameraTypeCode })
                .HasConstraintName("FK_Expiations_CameraLocation");
        });
