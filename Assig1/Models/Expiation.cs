...
public partial class Expiation
{
    ...
    public virtual CameraCode? CameraCode { get; set; }

    public virtual CountryState? DriverStateNavigation { get; set; }

    public virtual LocalServiceArea? LsaCodeNavigation { get; set; }

    public virtual Offence? OffenceCodeNavigation { get; set; }

    public virtual PhotoRejection? PhotoRejCodeNavigation { get; set; }

    public virtual CountryState? RegStateNavigation { get; set; }

    public virtual NoticeState? StatusCodeNavigation { get; set; }

    public virtual NoticeType? TypeCodeNavigation { get; set; }

    public virtual WithdrawnReason? WithdrawCodeNavigation { get; set; }
}
